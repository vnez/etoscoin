...
function usage()
{
    ...
    echo "and generates the checksum files of the ETOS Coin tag provided."
    echo
...
# -- Config
GITHUB_REPO="https://github.com/etosworld/etoscoin.git"
CLONE_DIR="$BUILD_DIRECTORY/etoscoin-buildall"
TARGET_DIR="$BUILD_DIRECTORY/etoscoin-releases"
DYNAMIC_RELEASE="etoscoin-${TAG_VERSION}-linux-CLI"
STATIC_RELEASE="etoscoin-${TAG_VERSION}-linux-staticboost-CLI"
